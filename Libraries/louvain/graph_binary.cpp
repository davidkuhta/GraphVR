...
GraphB::GraphB(stringstream& finput, int type) {
...
GraphB::GraphB(char *filename, char *filename_w, int type) {
  ifstream finput;
...
void
GraphB::assign_weight(int node, int weight) {
